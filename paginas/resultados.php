	...
	<section>
		<article>
			...
			if(isset($_POST["opcao"])){
				if($_POST["opcao"]=="buscar"){
					
					$executar = new Vaga($_POST);
					$processar=$executar->Processar_Metodo(); #resultados da pesquisa da pagina inicial
				...
				<div class="cards">
					...
					<p><a href="quero-esta-vaga.php?opcao=exibe&id_cargo=<?php echo $id_cargo; ?>&codigo=<?php echo $codigo; ?>" class="form-contact-button">eu quero esta vaga</a></p>
				</div>
			<?php 
					}
				}
			...
			if ($_GET["opcao"]=="certames"){
				$id_posts=$_GET['id_posts'];
				$posts = new Posts($_GET);
				...
				<div class="cards">
					<h2><?php echo $titulo; ?></h2>
					<p><?php echo $autor; ?> | <?php echo $data_publicacao; ?></p>
